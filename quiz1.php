...
{	
		...
		else if($submit=='Next' && isset($ans))
		{
				...
				$_SESSION[qn]=$_SESSION[qn]+1;
				echo "<h1 align='center' class='alert alert-success'> Congratulation!!!<br>You've just concluded the section section of the quiz</h1>";
				...
				echo "<h1 align=center '><a href=showtest3.php class='btn btn-primary'>Click Here To Continue To The Next Section</a> </h1>";
				unset($_SESSION[qn]);
				unset($_SESSION[sid]);
				unset($_SESSION[tid]);
...
echo "<tr align=center><td><input type=submit class='btn btn-primary'  name=submit value='Next'></form>";
echo "</table></table>";
?>
</div></div>
</div></div>
