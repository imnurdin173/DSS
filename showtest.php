...
echo "<h2 align='center'> Kindly take your time to take quiz on the following category  </h2>";
echo "<table align=center>";

while($row=mysql_fetch_row($rs))
{
	echo "<tr><td align=center >
	<a class='btn btn-info btn-mini' href=quiz.php?testid=$row[0]&subid=$subid>
	<font size=5>$row[2]</font></a>";
